...
public class ListWrapper<T> extends Widget implements Cullable {
    ...
    public ListWrapper (Skin skin, String styleName) {
        this(skin.get(styleName, List.ListStyle.class));
    }

    public ListWrapper (List.ListStyle style) {
        ...
        addListener(keyListener = new InputListener() {
            ...
            public boolean keyTyped (InputEvent event, char character) {
                ...
                for (int i = 0, n = items.size; i < n; i++) {
                    if (ListWrapper.this.toString(items.get(i)).toLowerCase().startsWith(prefix)) {
                        setSelectedIndex(i);
                        break;
                    }
                }
        ...
        addListener(new InputListener() {
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (getStage() != null) getStage().setKeyboardFocus(ListWrapper.this);
    ...
    public int getItemIndexAt (float y) {
        ...
        Drawable background = ListWrapper.this.style.background;
        if (background != null) {
