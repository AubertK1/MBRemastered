...
public class DoodleMap extends Pixmap {
    ...
    public Doodle outline;

    public DoodleMap(int width, int height, Format format, Doodle outline) {
        super(width, height, format);
        this.outline = outline;
        if(outline != null) outline.setDoodleMap(this);
    ...
    public void setOutline(Doodle outline) {
        this.outline = outline;
    }
