...
public class NetGdx2DPixmap implements Disposable {
...
*/
    ...
    public NetGdx2DPixmap(InputStream in, int requestedFormat) throws IOException {
        while(true){
...
*/
    ...
    public NetGdx2DPixmap(int width, int height, int format) throws GdxRuntimeException {
...
*/
    ...
    private void convert(int requestedFormat) {
        NetGdx2DPixmap pixmap = new NetGdx2DPixmap(this.width, this.height, requestedFormat);
        pixmap.setBlend(0);
    ...
    public void drawPixmap(NetGdx2DPixmap src, int srcX, int srcY, int dstX, int dstY, int width, int height) {
        drawPixmap(src.basePtr, this.basePtr, srcX, srcY, width, height, dstX, dstY, width, height);
    }

    public void drawPixmap(NetGdx2DPixmap src, int srcX, int srcY, int srcWidth, int srcHeight, int dstX, int dstY, int dstWidth, int dstHeight) {
    ...
    public static NetGdx2DPixmap newPixmap(InputStream in, int requestedFormat) {
        try {
            return new NetGdx2DPixmap(in, requestedFormat);
        } catch (IOException var3) {
            return null;
        }
    }

    public static NetGdx2DPixmap newPixmap(int width, int height, int format) {
        try {
            return new NetGdx2DPixmap(width, height, format);
